...
const subjects: Subject[] = [
  ...
  { name: "DAT (設計與應用科技)", slug: "dat", short: <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width:18,height:18}}><rect x="8" y="3" width="4" height="10" rx="0.8" fill="currentColor"/><rect x="5" y="3" width="10" height="3" rx="0.8" fill="currentColor"/></svg>, color: "#8277b8", soft: "#efedfa" },
